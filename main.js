...
document.getElementById("TBsketch").innerHTML = "sketch to be drawn: "+sketch
...
function gotresults(error, results) {
    ...
    document.getElementById("Csketch").innerHTML = "Confidence: "+ Math.floor(results[0].confidence*100)+"%"
}
